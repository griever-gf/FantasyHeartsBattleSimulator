...
namespace SFB {
    ...
    public class StandaloneFileBrowser {
        ...
        public static string[] OpenFilePanel(string title, string directory, string extension, bool multiselect, string defaultFileName) {
            var extensions = string.IsNullOrEmpty(extension) ? null : new [] { new ExtensionFilter("", extension) };
            return OpenFilePanel(title, directory, extensions, multiselect, defaultFileName);
        }
        ...
        /// <param name="multiselect">Allow multiple file selection</param>
        /// <returns>Returns array of chosen paths. Zero length array when cancelled</returns>
        public static string[] OpenFilePanel(string title, string directory, ExtensionFilter[] extensions, bool multiselect, string defaultFileName) {
            return _platformWrapper.OpenFilePanel(title, directory, extensions, multiselect, defaultFileName);
        }
